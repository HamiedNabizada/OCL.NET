// =============================================================================
// OCL.NET.RuleDemo — erzeugt den "So feuern die Regeln"-Anhang der
...
//
// Aufruf:
//   dotnet run --project tools/OCL.NET.RuleDemo -- <test.aml> <spec-Ordner> <ausgabe.tex>
// =============================================================================
using System.Text;
...
if (args.Length != 3)
{
    Console.Error.WriteLine("Aufruf: OCL.NET.RuleDemo <test.aml> <spec-Ordner> <ausgabe.tex>");
    return 1;
}
var amlPath = args[0];
var specDir = args[1];
...
{
    sb.AppendLine("% =============================================================================");
    sb.AppendLine("% GENERIERT durch OCL.NET.RuleDemo aus echten Engine-Laeufen gegen test.aml.");
