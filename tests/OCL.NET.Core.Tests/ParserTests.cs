...
public class ParserTests
{
    ...
    public static IEnumerable<object[]> PureRules() => new (string Id, string Ocl)[]
    {
        ...
        ("D1", "context FPD_Project inv UniqueIdentifiers: let allElements = self.process.containedElement->asSet() in allElements->forAll(e1, e2 | (e1 <> e2 and e1.identification.uniqueIdent->notEmpty() and e1.refObj <> e2.identification.uniqueIdent and e2.refObj <> e1.identification.uniqueIdent) implies e1.identification.uniqueIdent <> e2.identification.uniqueIdent)"),
